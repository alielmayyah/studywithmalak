...
1. Create a Supabase project. Run [`supabase/migrations/202609190001_init.sql`](supabase/migrations/202609190001_init.sql) in the SQL editor or apply it with the Supabase CLI.
...
No backend server is required. Live Presence and session updates require a connected Supabase project. Study and break actions run through a database function, with partial unique indexes preventing duplicate active sessions and breaks.
